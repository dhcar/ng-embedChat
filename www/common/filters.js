...
// 
// possibly use an ng-embed directive to determine which links should be embeddable (have "embed" class for oembed)
// 

.filter('parseUrl', function($sanitize, $sce) {
